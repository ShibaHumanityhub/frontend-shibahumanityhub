 ...
 * HH = network. Silver Paws = senior visit product.
...
(function () {
 ...
 '</div>' +
 '</div>' +
 '<div class="hhx-section-head" style="padding-top:0"><h2>Circles of Mercy</h2><p>How $NIBBLES holdings can fund the network when funding and delivery are live. These are design levels, not credits issued yet.</p></div>' +
 '<div class="hhx-set-grid">' +
