...
(function () {
  ...
  function styles() {
    ...
    s.textContent = [
      ...
      /* Broadcast */
      '.oca-broadcast{position:relative;z-index:2;padding:0 .9rem 2.5rem;max-width:72rem;margin:0 auto;width:100%}',
      '.oca-bcast-head{display:flex;flex-direction:column;align-items:flex-start;gap:.5rem;margin-bottom:.85rem}',
      '@media(min-width:640px){.oca-bcast-head{flex-direction:row;flex-wrap:wrap;align-items:flex-end;justify-content:space-between;gap:1rem}}',
      '.oca-bcast-title{font-family:Georgia,serif;font-size:clamp(1.35rem,5vw,2rem);margin:0;color:#fff;line-height:1.15}',
      '.oca-viewers{font-size:.7rem;color:#fca5a5;letter-spacing:.04em}',
      '.oca-stage{display:grid;grid-template-columns:1fr;gap:.85rem}',
      '@media(min-width:900px){.oca-stage{grid-template-columns:1.65fr .9fr;gap:1rem}}',
      '.oca-main-feed{position:relative;border-radius:1rem;overflow:hidden;border:1px solid rgba(232,197,71,.4);background:#000;box-shadow:0 0 0 1px rgba(196,30,58,.2),0 20px 50px -16px rgba(0,0,0,.85),0 0 50px -18px rgba(196,30,58,.45);aspect-ratio:16/10;width:100%}',
      '@media(min-width:640px){.oca-main-feed{aspect-ratio:16/9;border-radius:1.25rem}}',
      ...
      '.oca-feed-top{position:absolute;top:0;left:0;right:0;padding:.55rem .65rem;display:flex;justify-content:space-between;align-items:flex-start;gap:.5rem;z-index:3;pointer-events:none}',
      '@media(min-width:640px){.oca-feed-top{padding:.85rem 1rem}}',
      '.oca-feed-bot{position:absolute;bottom:0;left:0;right:0;padding:.55rem .65rem;z-index:3;pointer-events:none}',
      '@media(min-width:640px){.oca-feed-bot{padding:.85rem 1rem}}',
      '.oca-cam-tag{font-size:.55rem;letter-spacing:.1em;text-transform:uppercase;color:#fde68a;text-shadow:0 1px 4px #000}',
      '@media(min-width:640px){.oca-cam-tag{font-size:.65rem;letter-spacing:.16em}}',
      '.oca-cam-sub{font-size:.65rem;color:rgba(255,244,224,.75);margin-top:.15rem;line-height:1.3}',
      '@media(min-width:640px){.oca-cam-sub{font-size:.75rem}}',
      '.oca-rec{display:inline-flex;align-items:center;gap:.3rem;font-size:.55rem;letter-spacing:.1em;color:#fecaca;background:rgba(127,29,29,.8);padding:.28rem .45rem;border-radius:4px;flex-shrink:0}',
      '.oca-rec i{width:6px;height:6px;border-radius:50%;background:#ef4444;animation:oca-blink 1s ease infinite}',
      '.oca-ticker{margin-top:.55rem;overflow:hidden;border-radius:.65rem;border:1px solid rgba(232,197,71,.25);background:rgba(10,6,8,.9);white-space:nowrap;max-width:100%}',
      '.oca-ticker-track{display:inline-block;padding:.5rem 0;animation:oca-tick 32s linear infinite;font-size:.62rem;letter-spacing:.1em;text-transform:uppercase;color:rgba(253,230,138,.9)}',
      '.oca-ticker-track span{margin:0 1.5rem}',
      '@keyframes oca-tick{from{transform:translateX(0)}to{transform:translateX(-50%)}}',
      /* Mobile cam rail - horizontal scroll */
      '.oca-side{display:flex;flex-direction:column;gap:.55rem}',
      '.oca-thumbs{display:flex;gap:.5rem;overflow-x:auto;-webkit-overflow-scrolling:touch;padding-bottom:.25rem;scrollbar-width:none;margin:0 -.15rem;padding-left:.15rem;padding-right:.15rem}',
      '.oca-thumbs::-webkit-scrollbar{display:none}',
      '@media(min-width:900px){.oca-thumbs{display:grid;grid-template-columns:1fr 1fr;overflow:visible;margin:0;padding:0}}',
      '.oca-thumb{position:relative;border-radius:.75rem;overflow:hidden;border:1px solid rgba(255,255,255,.12);cursor:pointer;aspect-ratio:16/10;background:#111;transition:border-color .2s,box-shadow .2s;padding:0;font:inherit;color:inherit;text-align:left;flex:0 0 42%;min-width:140px;max-width:200px;touch-action:manipulation}',
      '@media(min-width:900px){.oca-thumb{flex:none;min-width:0;max-width:none;width:100%;border-radius:.9rem}}',
      ...
      '.oca-thumb-label{position:absolute;left:0;right:0;bottom:0;padding:.4rem .45rem;background:linear-gradient(transparent,rgba(0,0,0,.9));font-size:.52rem;letter-spacing:.08em;text-transform:uppercase;color:#fde68a;line-height:1.2}',
      '.oca-chat{border-radius:.9rem;border:1px solid rgba(232,197,71,.25);background:rgba(20,10,12,.92);padding:.7rem;min-height:120px;max-height:160px;overflow:auto;-webkit-overflow-scrolling:touch}',
      ...
      '.oca-honest{font-size:.65rem;color:rgba(255,244,224,.45);margin-top:.65rem;text-align:center;line-height:1.4;padding:0 .25rem}',
      /* Story */
