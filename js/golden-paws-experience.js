...
(function () {
 ...
 '.gpx-rail{position:sticky;top:0;z-index:55;display:flex;gap:.35rem;padding:.55rem max(.65rem,env(safe-area-inset-left));overflow-x:auto;scrollbar-width:none;-webkit-overflow-scrolling:touch;background:rgba(7,6,10,.99);border-bottom:1px solid var(--gp-line);justify-content:flex-start;box-shadow:0 8px 28px -12px rgba(0,0,0,.7);transform:translateZ(0)}',
 '@media(min-width:768px){.gpx-rail{background:linear-gradient(180deg,rgba(7,6,10,.99),rgba(7,6,10,.94));backdrop-filter:blur(14px);-webkit-backdrop-filter:blur(14px)}}',
