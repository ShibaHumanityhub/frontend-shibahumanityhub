      ...
      '<section id="program-stats" class="py-16 border-t border-white/10">' +
        '<div class="max-w-5xl mx-auto px-6">' +
          '<div class="text-center mb-10">' +
            '<p class="text-xs tracking-[0.25em] uppercase text-zinc-500 mb-2">Living proof layer</p>' +
            '<h2 class="text-3xl md:text-4xl font-bold">Program Statistics</h2>' +
            '<p class="text-zinc-400 mt-3 max-w-2xl mx-auto text-sm md:text-base">Reserved for real numbers when partners, rails, and reporting are live. No fake impact. Placeholders only.</p>' +
          '</div>' +
          '<div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-10">' +
            statCard('Lives touched', '—', 'When funded', theme) +
            statCard(isNibbles ? 'Dogs helped' : 'Children helped', '—', 'Verified only', theme) +
            statCard('On-chain flows', '—', 'Shibarium ledger', theme) +
            statCard('Active partners', '—', 'Agencies & homes', theme) +
          '</div>' +
          '<div class="rounded-3xl border ' + theme.border + ' bg-zinc-900/50 p-6 md:p-8">' +
            '<h3 class="text-lg font-semibold ' + theme.text + ' mb-3">Coming to this page</h3>' +
