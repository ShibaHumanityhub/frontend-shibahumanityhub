...
function humanize(text, rel) {
  const pairs = [
    ...
    [/In conclusion, /gi, ''],
    [/illustrative product design/gi, 'product design preview'],
    [/Illustrative /g, 'Demo '],
    [/illustrative /g, 'demo '],
    [/truth-first/gi, 'honest'],
    [/network engine/gi, 'network'],
    [/public face of/gi, 'roster for'],
    [/standing by for live field ops/gi, 'not a live placement feed'],
    [/Built for live ops · design standing by/g, 'Preview. Built for real ops when partners land'],
    [/Soul by soul · screen hard · fund the rest · truth first/g, 'Screen hard. Fund the rest. One dog at a time.'],
    [/Open mercy engine/g, 'Open the board'],
    [/Boots on the ground energy\. /g, ''],
    [/boots-ready design/gi, 'design preview'],
    [/field ops engine/gi, 'placement system'],
    [/Field desk/g, 'Desk'],
    [/Engine desk/g, 'Desk'],
    [/Zero theater/g, 'No fake wins'],
    [/Zero confusion/g, 'Easy to keep straight'],
    [/when rails are live/gi, 'when funding and delivery are live'],
    [/when rails land/gi, 'when funding lands'],
    [/until partners and rails land/gi, 'until partners and funding are real'],
    [/until partners \+ rails are live/gi, 'until partners and funding are real'],
    [/Design model until partners \+ rails are live/gi, 'Design only until partners and funding are real'],
  ];
