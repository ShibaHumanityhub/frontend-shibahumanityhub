...
rep('index.html', [
  ...
  [
    ...
    '$NIBBLES and $hopeseed on Shibarium. Built for shelter dogs, kids, and the people who need them. Truth first. When rails are live, holdings fund the work.'
  ],
  [
...
rep('all-programs.html', [
  ...
  [
    ...
    'Filters show which programs your holding can support when rails are live. We build this with you.'
  ]
]);
