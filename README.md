...
- **Single source of truth**: `js/programs-data.js` (the 30 programs with their fullHTML, thresholds, images, videos) and the `MERCY_THRESHOLDS` constant in index.html.
...
3. **Phase 3** - Beautiful interactive Mercy Impact Dashboard (visual circles that fill and glow, enhanced SVG ripple engine, richer personal view, compounding visual, shareable "Mercy Footprint", deep 30 integration, URL state).
...
5. **Phase 5** - Powerful showcase of the 30 (live search + circle filters with personal badges, stunning interactive Mercy Constellation SVG that reacts to your ripples, loving "Journey Through the Flywheel" scroller, community notes everywhere).
